                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row">
                            <form action="/home/proyek/{{$proyek->id}}/update" method="POST">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="nama">Nama</label>
                                    <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama" value="{{$proyek->nama}}">
                                </div>
                                <div class="form-group">
                                    <label for="kode">Kode</label>
                                    <input name="kode" type="text" class="form-control" id="kode" placeholder="Kode" value="{{$proyek->kode}}">
                                </div>
                                <div class="from-group">
                                    <label for="nilai">Nilai</label>
                                    <input name="nilai" type="text" class="form-control" id="nilai" placeholder="Nilai" value="{{$proyek->nilai}}">
                                </div>
                                <div>
                                    <button type="submit" class="btn btn-warning">Update</button>
                                    <a href="/home/proyek" class="btn btn-dark">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
